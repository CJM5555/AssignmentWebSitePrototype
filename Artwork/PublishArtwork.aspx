    ...
    <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br />
                            <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtPrice" ErrorMessage="Artwork Price cannot be negative! " MinimumValue="0" MaximumValue="9999999999999" ForeColor="Red" ValidationGroup="publish"></asp:RangeValidator>
                            <br />
